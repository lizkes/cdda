...
void init_colors()
{
    ...
    color_by_string_map = {
        {"br", {c_brown, to_translation("brown")}}, {"lg", {c_light_gray, to_translation("light gray")}}, {"dg", {c_dark_gray, to_translation("dark gray")}}, {"r", {c_light_red, to_translation("light red")}}, {"R", {c_red, to_translation("red")}}, {"g", {c_light_green, to_translation("light green")}}, {"G", {c_green, to_translation("green")}}, {"b", {c_light_blue, to_translation("light blue")}}, {"B", {c_blue, to_translation("blue")}}, {"W", {c_white, to_translation("white")}}, {"C", {c_cyan, to_translation("cyan")}}, {"c", {c_light_cyan, to_translation("light cyan")}}, {"P", {c_pink, to_translation("pink")}}, {"m", {c_magenta, to_translation("magenta")}}};
}
...
static void draw_header(const catacurses::window &w)
{
    ...
    tmpx += shortcut_print(w, point(tmpx, 0), c_white, c_light_green,
                           _("<R>emove custom color")) +
            2;
    tmpx += shortcut_print(w, point(tmpx, 0), c_white, c_light_green,
                           _("<Arrow Keys> To navigate")) +
            2;
