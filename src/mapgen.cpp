...
mapgen_function_json_base::mapgen_function_json_base(
    ...
    : jsrcloc(jsrcloc), context_(context), do_format(false), is_ready(false), mapgensize(SEEX * 2, SEEY * 2), objects(m_offset, mapgensize)
{
}
...
mapgen_function_json::mapgen_function_json(const json_source_location &jsrcloc, const int w,
    ...
    : mapgen_function(w), mapgen_function_json_base(jsrcloc, context), fill_ter(t_null), rotation(0)
{
...
mapgen_function_json_nested::mapgen_function_json_nested(
    const json_source_location &jsrcloc, const std::string &context)
    : mapgen_function_json_base(jsrcloc, context), rotation(0)
{
}
...
jmapgen_place::jmapgen_place(const JsonObject &jsi)
    : x(jsi, "x"), y(jsi, "y"), repeat(jsi, "repeat", 1, 1)
{
}
...
public:
    ...
    int intensity;
    time_duration age;
    jmapgen_field(const JsonObject &jsi, const std::string & /*context*/) : ftype(field_type_id(jsi.get_string("field"))), intensity(jsi.get_int("intensity", 1)), age(time_duration::from_turns(jsi.get_int("age", 0)))
    {
        if (!ftype.id())
        {
...
public:
    ...
    jmapgen_npc(const JsonObject &jsi, const std::string & /*context*/) : npc_class(jsi.get_string("class")), target(jsi.get_bool("target", false))
    {
        if (!npc_class.is_valid())
        {
            set_mapgen_defer(jsi, "class", string_format("unknown npc template %s", jsi.get_string("class")));
        }
...
public:
    translation signage;
    std::string snippet;
    jmapgen_sign(const JsonObject &jsi, const std::string & /*context*/) : snippet(jsi.get_string("snippet", ""))
    {
...
public:
    translation text;
    std::string snippet;
    jmapgen_graffiti(const JsonObject &jsi, const std::string & /*context*/) : snippet(jsi.get_string("snippet", ""))
    {
        jsi.read("text", text);
...
public:
    ...
    jmapgen_vending_machine(const JsonObject &jsi, const std::string & /*context*/) : reinforced(jsi.get_bool("reinforced", false)), group_id(jsi.get_string("item_group", "default_vending_machine"))
    {
...
public:
    jmapgen_int amount;
    jmapgen_toilet(const JsonObject &jsi, const std::string & /*context*/) : amount(jsi, "amount", 0, 0)
    {
    }
    void apply(const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y) const override
    {
...
public:
    jmapgen_int amount;
    std::string fuel;
    jmapgen_gaspump(const JsonObject &jsi, const std::string & /*context*/) : amount(jsi, "amount", 0, 0)
    {
...
public:
    ...
    std::string liquid;
    jmapgen_int chance;
    jmapgen_liquid_item(const JsonObject &jsi, const std::string & /*context*/) : amount(jsi, "amount", 0, 0), liquid(jsi.get_string("liquid")), chance(jsi, "chance", 1, 1)
    {
...
public:
    item_group_id group_id;
    jmapgen_int chance;
    jmapgen_item_group(const JsonObject &jsi, const std::string &context) : chance(jsi, "chance", 1, 1)
    {
...
public:
    jmapgen_loot(const JsonObject &jsi) : result_group(Item_group::Type::G_COLLECTION, 100, jsi.get_int("ammo", 0),
...
public:
    ...
    float density;
    jmapgen_int chance;
    jmapgen_monster_group(const JsonObject &jsi, const std::string & /*context*/) : id(jsi.get_string("monster")), density(jsi.get_float("density", -1.0f)), chance(jsi, "chance", 1, 1)
    {
        if (!id.is_valid())
        {
...
public:
    ...
    jmapgen_monster(const JsonObject &jsi, const std::string & /*context*/) : chance(jsi, "chance", 100, 100), pack_size(jsi, "pack_size", 1, 1), one_or_none(jsi.get_bool("one_or_none",
                                                                                                                                                                           !(jsi.has_member("repeat") || jsi.has_member("pack_size")))),
                                                                              friendly(jsi.get_bool("friendly", false)), name(jsi.get_string("name", "NONE")), target(jsi.get_bool("target", false))
    {
...
public:
    ...
    int fuel;
    int status;
    jmapgen_vehicle(const JsonObject &jsi, const std::string & /*context*/) : type(jsi.get_string("vehicle")), chance(jsi, "chance", 1, 1)
                                                                              ...
                                                                              ,
                                                                              fuel(jsi.get_int("fuel", -1)), status(jsi.get_int("status", -1))
    {
...
public:
    ...
    jmapgen_spawn_item(const JsonObject &jsi, const std::string & /*context*/) : type(jsi.get_string("item")), amount(jsi, "amount", 1, 1), chance(jsi, "chance", 100, 100), flags(jsi.get_tags<flag_id>("custom-flags"))
    {
        // Itemgroups apply migrations when being loaded, but we need to migrate
        // individual items here.
...
public:
    trap_id id;
    jmapgen_trap(const JsonObject &jsi, const std::string & /*context*/) : id(0)
    {
    ...
    jmapgen_trap(const std::string &tid) : id(0)
    {
...
public:
    furn_id id;
    jmapgen_furniture(const JsonObject &jsi, const std::string & /*context*/) : jmapgen_furniture(jsi.get_string("furn")) {}
...
public:
    ter_id id;
    jmapgen_terrain(const JsonObject &jsi, const std::string & /*context*/) : jmapgen_terrain(jsi.get_string("ter")) {}
...
public:
    ...
    jmapgen_ter_furn_transform(const JsonObject &jsi, const std::string & /*context*/) : jmapgen_ter_furn_transform(jsi.get_string("transform")) {}
...
public:
    ...
    jmapgen_sealed_item(const JsonObject &jsi, const std::string &context)
        : furniture(jsi.get_string("furniture")), chance(jsi, "chance", 100, 100)
    {
...
public:
    ...
    jmapgen_nested(const JsonObject &jsi, const std::string & /*context*/) : neighbors(jsi.get_object("neighbors"))
    {
...
jmapgen_objects::jmapgen_objects(const point &offset, const point &mapsize)
    : m_offset(offset), mapgensize(mapsize)
{
}
...
void map::draw_lab(mapgendata &dat)
{
        ...
        terrain_type == "tower_lab" || terrain_type == "tower_lab_stairs")
    {
        ...
        { // We're below ground, and no sewers
            ...
            else
            {
                ...
                { // then no json maps for lab_4side were found
                    switch (rng(1, 3))
                    {
                    case 1:
                        // Cross shaped
             ...
             terrain_type == "central_lab_finale" || terrain_type == "tower_lab_finale")
    {
        ...
        { // then no json maps for lab_finale_1level were found
            ...
            case 2:
                ...
                if (loot_variant <= 96)
                {
                    ...
                    { // loot_variant between 90 and 96.
                ...
                { // 4% of the lab ends will be this weapons testing end.
            ...
            case 3:
            {
                ...
                if (monsters_end)
                { //only add these options when there are monsters.
                ...
                while (item_count < 5)
                {
                    item_count +=
                        place_items(
                            ...
                            point(SEEX, SEEY), false, calendar::start_of_cataclysm)
                            .size();
                }
...
void map::draw_temple(const mapgendata &dat)
{
    ...
    if (terrain_type == "temple" || terrain_type == "temple_stairs")
    {
        ...
        else
        {
            ...
            switch (1 + std::abs(abs_sub.y / 2 + dat.zlevel() + 4) % 4)
            { // TODO: More varieties!
            ...
            case 2:
                ...
                square(this, t_water_dp, point(SEEX * 2 - 5, SEEY * 2 - 5), point(SEEX * 2 - 4, SEEY * 2 - 4));
...
void map::draw_mine(mapgendata &dat)
{
             ...
             terrain_type == "mine_down")
    {
        ...
        if (dat.above() == "mine_shaft")
        { // We need the entrance room
        ...
        if (terrain_type == "mine_down")
        { // Don't forget to build a slope down!
            ...
            if (open.empty())
            { // We'll have to build it in the center
                int tries = 0;
                point p;
                bool okay = true;
                do
                ...
                if (tries == 10)
                { // Clear the area around the slope down
        ...
        if (dat.above() == "mine_down")
        { // Don't forget to build a slope up!
            std::vector<direction> open;
...
void map::draw_triffid(const mapgendata &dat)
{
    ...
    if (terrain_type == "triffid_roots")
    {
        ...
        do
        {
            ...
            if (step > 2)
            { // First couple of chambers are safe
                int monrng = rng(1, 25);
    ...
    else if (terrain_type == "triffid_finale")
    {
        ...
        do
        {
            ...
            if (chance >= 10 && one_in(10))
            { // Add a spawn
                place_spawns(GROUP_TRIFFID, 1, point(x, y), point(x, y), 1, true);
            }

            if (rng(0, 99) < chance)
            { // Force movement down or to the right
                if (x >= 19)
                {
                    y++;
                }
...
void map::draw_connections(const mapgendata &dat)
{
    ...
    if (is_ot_match("subway", terrain_type,
                    ot_match_type::type))
    { // FUUUUU it's IF ELIF ELIF ELIF's mini-me =[
...
void science_room(map *m, const point &p1, const point &p2, int z, int rotate)
{
    ...
    int width = p2.x - p1.x;
    if (rotate % 2 == 1)
    { // Swap width & height if we're a lateral room
        int tmp = height;
        height = width;
        width = tmp;
    }
    ...
    case room_teleport:
        ...
        m->place_items(item_group_id("teleport"), 70, point((p1.x + p2.x) / 2, static_cast<int>((p1.y + p2.y) / 2)),
...
void build_mine_room(room_type type, const point &p1, const point &p2, const mapgendata &dat)
{
    ...
    { // We're in the middle of the map!
        if (mid.x <= SEEX)
        {
            possibilities.push_back(direction::EAST);
        }
    ...
    if (type == room_mine_fuel)
    { // Fuel stations are open on one side
        switch (door_side)
        {
        case direction::NORTH:
    ...
    {
        if (type == room_mine_storage)
        { // Storage has a locked door
...
update_mapgen_function_json::update_mapgen_function_json(
    const json_source_location &jsrcloc, const std::string &context) : mapgen_function_json_base(jsrcloc, context)
{
}
